...
class AnimatedLogo extends React.Component {
  componentDidMount() {
    ...
    tl.from(".title-box",.6, {ease: Power3.easeInOut,  opacity: 0}); 
    tl.from(".title-box",.6, {ease: Power3.easeInOut, rotation: 4,  y: 40, scaleY:1.4}, 0); // both start at time: 0 
  
    tl.from(".subtitle-box",.7, {ease: Power3.easeInOut, rotation: 4, opacity: 0}, 0.25); 
    tl.from(".subtitle-box",.7, {ease: Power3.easeInOut, y: 20, scaleY:1.4}, 0.25);
  ...
  render() {    
    return (
      <div>
        ...
        <NewTitle className="subtitle-box">Agency</NewTitle>
    </div>
